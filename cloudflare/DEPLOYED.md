...
**Open in Safari:**  
https://cwayclient-cursor-proxy.ivy-constrictor.workers.dev

**Claim now:**  
https://dash.cloudflare.com/claim-preview?claimToken=Ib_3QO5IIlCTAR-ja_vT3QQSgKe0ANwvAnFi9qdsQSo

Cursor + ElevenLabs keys pre-filled. JARVIS coordinator system prompt live.

**Instant replies:** answers now stream word-by-word (Workers AI SSE) on the `llama-3.1-8b-instruct-fast` model, and the proxy health probe is cached so no round-trips happen before the AI call.
